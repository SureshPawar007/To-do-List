...
const templating = (arr) => {
    ...
    arr.forEach(obj => {
        result += `
                    <li class="list-group-item font-weight-bold mb-2 d-flex justify-content-between text-uppercase text-center" id='${obj.skillId}'>
                            <span>${obj.skillName}</span>
                            <span >
                                <i class="fa-solid fa-pen-to-square mr-2 fa-2x edit"
                                onclick = "onItemEdit(this)"  
                                data-id='${obj.skillId}'></i>
                                <i class="fa-solid fa-trash-can fa-2x delete"
...
const onFormSubmit = (eve) => {
    ...
    li.className = 'list-group-item font-weight-bold mb-2 d-flex justify-content-between text-uppercase text-center'
    li.innerHTML = `
